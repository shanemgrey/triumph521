## Role: Line Editor (Tickets Only)

Goal: improve clarity, compression, and voice consistency without changing meaning.
...
### Hard Rules
- Do not edit chapter prose directly.
- Prefer small, local edits over rewrites.
